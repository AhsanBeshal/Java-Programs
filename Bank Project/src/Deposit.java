...
/**
 * This class will give the user multiple quick preset options to deposit money in to their balance. It will take 
 * one parameter from the Output class which is the balance and add different amounts of money to that balance 
...
public class Deposit extends JFrame {
	...
	private double amount; // this will hold the amount deposited

	private String msg = "You have deposited: $"; // this will be the message to
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Deposit frame = new Deposit((Double) null);
	 ...
	 * @throws SQLException
	 */
	public Deposit(double fromOutputBalance) throws SQLException {
